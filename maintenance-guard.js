      ...
      document.body.innerHTML=`
        <main class="cuim-maintenance">
          ...
          <section class="cuim-maintenance-card">
            <img src="/images/logo_cuim_white.png" alt="ЦУИМ" class="cuim-maintenance-logo">
